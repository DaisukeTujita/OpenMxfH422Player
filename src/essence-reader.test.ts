...
const table = (bodySid:number|undefined, keyFrameOffset:number, editUnit=0):MxfIndexTable => ({bodySid,indexSid:bodySid,editRateNumerator:30,editRateDenominator:1,startPosition:editUnit,duration:1,entries:[{editUnit,streamOffset:0n,keyFrameOffset}]});
